(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">你有多了解陈奕迅呢？快来测试一下吧。<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        exitFob = '<div class="results-container slide-container"><div class="question-number">' + config.endText + '</div><div class="result-keeper"></div></div><div class="notice" style="display: block; bottom: 20px;left: 360px;">请选择一个选项！</div>',
        contentFob = '',
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            if (questionsIteratorIndex < config.questions.length - 1) {
                ...
                contentFob += '<div class="next final" style= "width:95px; height: 32px; padding-left: 0px; padding-right: 0px;"><a class="nav-show-result" href="#" style= "padding-left: 0px;">完成</a></div>';
            }
            contentFob += '</div></div>';
